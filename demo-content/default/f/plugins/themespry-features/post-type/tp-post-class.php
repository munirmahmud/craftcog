...
/**
 *
 * Custom Post Type And Taxonomies Classes
 *
 */

namespace TpCustomPost;
...
class TP_CustomPost {
  ...
  private $tp_posts;
    ...
    public function tp_post_init( $type, $singular_label, $plural_label, $settings = array() ){
        ...
        $this->tp_posts[$type] = array_merge($default_settings, $settings);
    }

    public function register_custom_post(){
        foreach($this->tp_posts as $key=>$value) {
...
class TP_Taxonomies {
    ...
    public function tp_post_init( $type, $singular_label, $plural_label, $post_types, $settings = array() ){
        $default_settings = array(
            'labels' => array(
                'name' => __($plural_label, $this->textdomain),
                'singular_name' => __($singular_label, $this->textdomain),
