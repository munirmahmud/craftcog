...
class CraftCog_Contact extends WP_Widget
{
    function __construct() {
        $widget_opt = array(
            'classname'     => 'craftcog_widget',
            'description'   => 'CraftCog Contact'
        );
        
        parent::__construct('tp-contacts', esc_html__('CraftCog Contact', 'craftcog'), $widget_opt);
    }
    ...
    function form($instance){
    	if(isset($instance['title'])){
            ...
            $title = esc_html__( 'Contact', 'craftcog' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address' )); ?>"><?php esc_html_e( 'Address One:' , 'craftcog' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'address_one' )); ?>"><?php esc_html_e( 'Address Two:' , 'craftcog' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mobile' )); ?>"><?php esc_html_e( 'Mobile:' , 'craftcog' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'email' )); ?>"><?php esc_html_e( 'Email:' , 'craftcog' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'fax' )); ?>"><?php esc_html_e( 'Fax:' , 'craftcog' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'open_time' )); ?>"><?php esc_html_e( 'Open Hour:' , 'craftcog' ); ?></label>
