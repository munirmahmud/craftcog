        ...
        <?php if (count($groups) > 1): ?>
            <div class="fw-backend-option-fixed-width">
                <select class="js-option-type-new-icon-dropdown">
                    <?php
                    echo fw_html_tag('option', array('value' => 'all'), htmlspecialchars(esc_html__('All Categories', 'craftcog')));
                ...
                <div class="fw-icon-search-holder">
                    <input type="text" class="fw-icon-search" placeholder="<?php esc_attr_e( 'icon search', 'craftcog' ) ?>">
