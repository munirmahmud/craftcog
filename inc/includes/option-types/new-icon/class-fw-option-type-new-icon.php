...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( GEOBIN_INC . '/includes/option-types/new-icon/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'craftcog' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'craftcog' ),
					'hand'				 => esc_html__( 'Hand Icons', 'craftcog' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'craftcog' ),
					'gender'			 => esc_html__( 'Gender Icons', 'craftcog' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'craftcog' ),
					'payment'			 => esc_html__( 'Payment Icons', 'craftcog' ),
					'currency'			 => esc_html__( 'Currency Icons', 'craftcog' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'craftcog' ),
					'directional'		 => esc_html__( 'Directional Icons', 'craftcog' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'craftcog' ),
					'brand'				 => esc_html__( 'Brand Icons', 'craftcog' ),
					'medical'			 => esc_html__( 'Medical Icons', 'craftcog' ),
					'finences-icons'	 => esc_html__( 'Finences Icons', 'craftcog' ),
				),
				'icons'				 => array(
					...
					//Finance Icons
					'icon icon-balloon'				 => array( 'group' => 'finences-icons' ),
					'icon icon-car'					 => array( 'group' => 'finences-icons' ),
					'icon icon-community'			 => array( 'group' => 'finences-icons' ),
					'icon icon-dream_home'			 => array( 'group' => 'finences-icons' ),
					'icon icon-employee'			 => array( 'group' => 'finences-icons' ),
					'icon icon-family'				 => array( 'group' => 'finences-icons' ),
					'icon icon-heart'				 => array( 'group' => 'finences-icons' ),
					'icon icon-home2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-love'				 => array( 'group' => 'finences-icons' ),
					'icon icon-travel'				 => array( 'group' => 'finences-icons' ),
					'icon icon-employee'			 => array( 'group' => 'finences-icons' ),
					'icon icon-deal'				 => array( 'group' => 'finences-icons' ),
					'icon icon-left-arrow2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-quote2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-right-arrow2'		 => array( 'group' => 'finences-icons' ),
					'icon icon-coins-2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-commerce-2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-monitor'				 => array( 'group' => 'finences-icons' ),
					'icon icon-graphic-3'			 => array( 'group' => 'finences-icons' ),
					'icon icon-business'			 => array( 'group' => 'finences-icons' ),
					'icon icon-graphic-2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-commerce-1'			 => array( 'group' => 'finences-icons' ),
					'icon icon-hammer'				 => array( 'group' => 'finences-icons' ),
					'icon icon-graphic-1'			 => array( 'group' => 'finences-icons' ),
					'icon icon-graphic'				 => array( 'group' => 'finences-icons' ),
					'icon icon-justice-1'			 => array( 'group' => 'finences-icons' ),
					'icon icon-line'				 => array( 'group' => 'finences-icons' ),
					'icon icon-money-3'				 => array( 'group' => 'finences-icons' ),
					'icon icon-chart'				 => array( 'group' => 'finences-icons' ),
					'icon icon-commerce'			 => array( 'group' => 'finences-icons' ),
					'icon icon-agenda'				 => array( 'group' => 'finences-icons' ),
					'icon icon-money-2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-justice'				 => array( 'group' => 'finences-icons' ),
					'icon icon-money-1'				 => array( 'group' => 'finences-icons' ),
					'icon icon-money'				 => array( 'group' => 'finences-icons' ),
					'icon icon-technology'			 => array( 'group' => 'finences-icons' ),
					'icon icon-coins-1'				 => array( 'group' => 'finences-icons' ),
					'icon icon-coins'				 => array( 'group' => 'finences-icons' ),
					'icon icon-left-arrow'			 => array( 'group' => 'finences-icons' ),
					'icon icon-bank'				 => array( 'group' => 'finences-icons' ),
					'icon icon-calculator'			 => array( 'group' => 'finences-icons' ),
					'icon icon-chart2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-chart22'				 => array( 'group' => 'finences-icons' ),
					'icon icon-checked'				 => array( 'group' => 'finences-icons' ),
					'icon icon-clock3'				 => array( 'group' => 'finences-icons' ),
					'icon icon-comment'				 => array( 'group' => 'finences-icons' ),
					'icon icon-comments'			 => array( 'group' => 'finences-icons' ),
					'icon icon-consult'				 => array( 'group' => 'finences-icons' ),
					'icon icon-consut2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-download'			 => array( 'group' => 'finences-icons' ),
					'icon icon-envelope'			 => array( 'group' => 'finences-icons' ),
					'icon icon-euro'				 => array( 'group' => 'finences-icons' ),
					'icon icon-folder'				 => array( 'group' => 'finences-icons' ),
					'icon icon-invest'				 => array( 'group' => 'finences-icons' ),
					'icon icon-loan'				 => array( 'group' => 'finences-icons' ),
					'icon icon-map-marker2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-mutual-fund'			 => array( 'group' => 'finences-icons' ),
					'icon icon-percent'				 => array( 'group' => 'finences-icons' ),
					'icon icon-phone3'				 => array( 'group' => 'finences-icons' ),
					'icon icon-pie-chart2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-play'				 => array( 'group' => 'finences-icons' ),
					'icon icon-savings'				 => array( 'group' => 'finences-icons' ),
					'icon icon-search'				 => array( 'group' => 'finences-icons' ),
					'icon icon-tag'					 => array( 'group' => 'finences-icons' ),
					'icon icon-tags'				 => array( 'group' => 'finences-icons' ),
					'icon icon-tax'					 => array( 'group' => 'finences-icons' ),
					'icon icon-vplay'				 => array( 'group' => 'finences-icons' ),
					'icon icon-newsletter'			 => array( 'group' => 'finences-icons' ),
					'icon icon-mobile2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-laptop2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-desktop2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-tablet2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-phone2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-document'			 => array( 'group' => 'finences-icons' ),
					'icon icon-documents'			 => array( 'group' => 'finences-icons' ),
					'icon icon-search2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-clipboard2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-newspaper'			 => array( 'group' => 'finences-icons' ),
					'icon icon-notebook'			 => array( 'group' => 'finences-icons' ),
					'icon icon-book-open'			 => array( 'group' => 'finences-icons' ),
					'icon icon-browser'				 => array( 'group' => 'finences-icons' ),
					'icon icon-calendar2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-presentation'		 => array( 'group' => 'finences-icons' ),
					'icon icon-picture'				 => array( 'group' => 'finences-icons' ),
					'icon icon-pictures'			 => array( 'group' => 'finences-icons' ),
					'icon icon-video'				 => array( 'group' => 'finences-icons' ),
					'icon icon-camera2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-printer'				 => array( 'group' => 'finences-icons' ),
					'icon icon-toolbox'				 => array( 'group' => 'finences-icons' ),
					'icon icon-briefcase2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-wallet'				 => array( 'group' => 'finences-icons' ),
					'icon icon-gift2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-bargraph'			 => array( 'group' => 'finences-icons' ),
					'icon icon-grid'				 => array( 'group' => 'finences-icons' ),
					'icon icon-expand2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-focus'				 => array( 'group' => 'finences-icons' ),
					'icon icon-edit2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-adjustments'			 => array( 'group' => 'finences-icons' ),
					'icon icon-ribbon'				 => array( 'group' => 'finences-icons' ),
					'icon icon-hourglass2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-lock2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-megaphone'			 => array( 'group' => 'finences-icons' ),
					'icon icon-shield2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-trophy2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-flag2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-map2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-puzzle'				 => array( 'group' => 'finences-icons' ),
					'icon icon-basket'				 => array( 'group' => 'finences-icons' ),
					'icon icon-envelope2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-streetsign'			 => array( 'group' => 'finences-icons' ),
					'icon icon-telescope'			 => array( 'group' => 'finences-icons' ),
					'icon icon-gears2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-key2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-paperclip2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-attachment'			 => array( 'group' => 'finences-icons' ),
					'icon icon-pricetags'			 => array( 'group' => 'finences-icons' ),
					'icon icon-lightbulb'			 => array( 'group' => 'finences-icons' ),
					'icon icon-layers'				 => array( 'group' => 'finences-icons' ),
					'icon icon-pencil2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-tools'				 => array( 'group' => 'finences-icons' ),
					'icon icon-tools-2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-scissors2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-paintbrush'			 => array( 'group' => 'finences-icons' ),
					'icon icon-magnifying-glass'	 => array( 'group' => 'finences-icons' ),
					'icon icon-circle-compass'		 => array( 'group' => 'finences-icons' ),
					'icon icon-linegraph'			 => array( 'group' => 'finences-icons' ),
					'icon icon-mic'					 => array( 'group' => 'finences-icons' ),
					'icon icon-strategy'			 => array( 'group' => 'finences-icons' ),
					'icon icon-beaker'				 => array( 'group' => 'finences-icons' ),
					'icon icon-caution'				 => array( 'group' => 'finences-icons' ),
					'icon icon-recycle2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-anchor2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-profile-male'		 => array( 'group' => 'finences-icons' ),
					'icon icon-profile-female'		 => array( 'group' => 'finences-icons' ),
					'icon icon-bike'				 => array( 'group' => 'finences-icons' ),
					'icon icon-wine'				 => array( 'group' => 'finences-icons' ),
					'icon icon-hotairballoon'		 => array( 'group' => 'finences-icons' ),
					'icon icon-globe2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-genius'				 => array( 'group' => 'finences-icons' ),
					'icon icon-map-pin2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-dial'				 => array( 'group' => 'finences-icons' ),
					'icon icon-chat'				 => array( 'group' => 'finences-icons' ),
					'icon icon-heart2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-cloud2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-upload2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-download2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-target'				 => array( 'group' => 'finences-icons' ),
					'icon icon-hazardous'			 => array( 'group' => 'finences-icons' ),
					'icon icon-piechart'			 => array( 'group' => 'finences-icons' ),
					'icon icon-speedometer'			 => array( 'group' => 'finences-icons' ),
					'icon icon-global'				 => array( 'group' => 'finences-icons' ),
					'icon icon-compass2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-lifesaver'			 => array( 'group' => 'finences-icons' ),
					'icon icon-clock'				 => array( 'group' => 'finences-icons' ),
					'icon icon-aperture'			 => array( 'group' => 'finences-icons' ),
					'icon icon-quote'				 => array( 'group' => 'finences-icons' ),
					'icon icon-scope'				 => array( 'group' => 'finences-icons' ),
					'icon icon-alarmclock'			 => array( 'group' => 'finences-icons' ),
					'icon icon-refresh2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-happy'				 => array( 'group' => 'finences-icons' ),
					'icon icon-sad'					 => array( 'group' => 'finences-icons' ),
					'icon icon-facebook2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-twitter2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-googleplus'			 => array( 'group' => 'finences-icons' ),
					'icon icon-rss2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-tumblr2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-linkedin2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-dribbble2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-home'				 => array( 'group' => 'finences-icons' ),
					'icon icon-apartment'			 => array( 'group' => 'finences-icons' ),
					'icon icon-pencil'				 => array( 'group' => 'finences-icons' ),
					'icon icon-magic-wand'			 => array( 'group' => 'finences-icons' ),
					'icon icon-drop'				 => array( 'group' => 'finences-icons' ),
					'icon icon-lighter'				 => array( 'group' => 'finences-icons' ),
					'icon icon-poop'				 => array( 'group' => 'finences-icons' ),
					'icon icon-sun'					 => array( 'group' => 'finences-icons' ),
					'icon icon-moon'				 => array( 'group' => 'finences-icons' ),
					'icon icon-cloud'				 => array( 'group' => 'finences-icons' ),
					'icon icon-cloud-upload'		 => array( 'group' => 'finences-icons' ),
					'icon icon-cloud-download'		 => array( 'group' => 'finences-icons' ),
					'icon icon-cloud-sync'			 => array( 'group' => 'finences-icons' ),
					'icon icon-cloud-check'			 => array( 'group' => 'finences-icons' ),
					'icon icon-database'			 => array( 'group' => 'finences-icons' ),
					'icon icon-lock3'				 => array( 'group' => 'finences-icons' ),
					'icon icon-cog2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-trash2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-dice'				 => array( 'group' => 'finences-icons' ),
					'icon icon-heart3'				 => array( 'group' => 'finences-icons' ),
					'icon icon-star2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-star-half2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-star-empty'			 => array( 'group' => 'finences-icons' ),
					'icon icon-flag3'				 => array( 'group' => 'finences-icons' ),
					'icon icon-envelope3'			 => array( 'group' => 'finences-icons' ),
					'icon icon-paperclip'			 => array( 'group' => 'finences-icons' ),
					'icon icon-inbox'				 => array( 'group' => 'finences-icons' ),
					'icon icon-eye'					 => array( 'group' => 'finences-icons' ),
					'icon icon-printer2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-file-empty'			 => array( 'group' => 'finences-icons' ),
					'icon icon-file-add'			 => array( 'group' => 'finences-icons' ),
					'icon icon-enter'				 => array( 'group' => 'finences-icons' ),
					'icon icon-exit'				 => array( 'group' => 'finences-icons' ),
					'icon icon-graduation-hat'		 => array( 'group' => 'finences-icons' ),
					'icon icon-license'				 => array( 'group' => 'finences-icons' ),
					'icon icon-music-note'			 => array( 'group' => 'finences-icons' ),
					'icon icon-film-play'			 => array( 'group' => 'finences-icons' ),
					'icon icon-camera-video'		 => array( 'group' => 'finences-icons' ),
					'icon icon-camera'				 => array( 'group' => 'finences-icons' ),
					'icon icon-picture2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-book'				 => array( 'group' => 'finences-icons' ),
					'icon icon-bookmark'			 => array( 'group' => 'finences-icons' ),
					'icon icon-user2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-users'				 => array( 'group' => 'finences-icons' ),
					'icon icon-shirt'				 => array( 'group' => 'finences-icons' ),
					'icon icon-store'				 => array( 'group' => 'finences-icons' ),
					'icon icon-cart'				 => array( 'group' => 'finences-icons' ),
					'icon icon-tag2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-phone-handset'		 => array( 'group' => 'finences-icons' ),
					'icon icon-phone'				 => array( 'group' => 'finences-icons' ),
					'icon icon-pushpin'				 => array( 'group' => 'finences-icons' ),
					'icon icon-map-marker'			 => array( 'group' => 'finences-icons' ),
					'icon icon-map'					 => array( 'group' => 'finences-icons' ),
					'icon icon-location'			 => array( 'group' => 'finences-icons' ),
					'icon icon-calendar-full'		 => array( 'group' => 'finences-icons' ),
					'icon icon-keyboard'			 => array( 'group' => 'finences-icons' ),
					'icon icon-spell-check'			 => array( 'group' => 'finences-icons' ),
					'icon icon-screen'				 => array( 'group' => 'finences-icons' ),
					'icon icon-smartphone'			 => array( 'group' => 'finences-icons' ),
					'icon icon-tablet'				 => array( 'group' => 'finences-icons' ),
					'icon icon-laptop'				 => array( 'group' => 'finences-icons' ),
					'icon icon-laptop-phone'		 => array( 'group' => 'finences-icons' ),
					'icon icon-power-switch'		 => array( 'group' => 'finences-icons' ),
					'icon icon-bubble'				 => array( 'group' => 'finences-icons' ),
					'icon icon-heart-pulse'			 => array( 'group' => 'finences-icons' ),
					'icon icon-construction'		 => array( 'group' => 'finences-icons' ),
					'icon icon-pie-chart'			 => array( 'group' => 'finences-icons' ),
					'icon icon-chart-bars'			 => array( 'group' => 'finences-icons' ),
					'icon icon-gift'				 => array( 'group' => 'finences-icons' ),
					'icon icon-diamond2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-dinner'				 => array( 'group' => 'finences-icons' ),
					'icon icon-coffee-cup'			 => array( 'group' => 'finences-icons' ),
					'icon icon-leaf'				 => array( 'group' => 'finences-icons' ),
					'icon icon-paw'					 => array( 'group' => 'finences-icons' ),
					'icon icon-rocket'				 => array( 'group' => 'finences-icons' ),
					'icon icon-briefcase'			 => array( 'group' => 'finences-icons' ),
					'icon icon-bus2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-car2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-train'				 => array( 'group' => 'finences-icons' ),
					'icon icon-bicycle2'			 => array( 'group' => 'finences-icons' ),
					'icon icon-wheelchair'			 => array( 'group' => 'finences-icons' ),
					'icon icon-select'				 => array( 'group' => 'finences-icons' ),
					'icon icon-earth'				 => array( 'group' => 'finences-icons' ),
					'icon icon-smile'				 => array( 'group' => 'finences-icons' ),
					'icon icon-sad2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-neutral'				 => array( 'group' => 'finences-icons' ),
					'icon icon-mustache'			 => array( 'group' => 'finences-icons' ),
					'icon icon-alarm'				 => array( 'group' => 'finences-icons' ),
					'icon icon-bullhorn'			 => array( 'group' => 'finences-icons' ),
					'icon icon-volume-high'			 => array( 'group' => 'finences-icons' ),
					'icon icon-volume-medium'		 => array( 'group' => 'finences-icons' ),
					'icon icon-volume-low'			 => array( 'group' => 'finences-icons' ),
					'icon icon-volume'				 => array( 'group' => 'finences-icons' ),
					'icon icon-mic2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-hourglass'			 => array( 'group' => 'finences-icons' ),
					'icon icon-undo'				 => array( 'group' => 'finences-icons' ),
					'icon icon-redo'				 => array( 'group' => 'finences-icons' ),
					'icon icon-sync'				 => array( 'group' => 'finences-icons' ),
					'icon icon-history'				 => array( 'group' => 'finences-icons' ),
					'icon icon-clock2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-download3'			 => array( 'group' => 'finences-icons' ),
					'icon icon-upload'				 => array( 'group' => 'finences-icons' ),
					'icon icon-enter-down'			 => array( 'group' => 'finences-icons' ),
					'icon icon-exit-up'				 => array( 'group' => 'finences-icons' ),
					'icon icon-bug'					 => array( 'group' => 'finences-icons' ),
					'icon icon-code2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-link'				 => array( 'group' => 'finences-icons' ),
					'icon icon-unlink'				 => array( 'group' => 'finences-icons' ),
					'icon icon-thumbs-up'			 => array( 'group' => 'finences-icons' ),
					'icon icon-thumbs-down'			 => array( 'group' => 'finences-icons' ),
					'icon icon-magnifier'			 => array( 'group' => 'finences-icons' ),
					'icon icon-cross'				 => array( 'group' => 'finences-icons' ),
					'icon icon-menu'				 => array( 'group' => 'finences-icons' ),
					'icon icon-list'				 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-up'			 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-down'		 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-left'		 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-right'		 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-up'			 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-down'			 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-left'			 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-right'			 => array( 'group' => 'finences-icons' ),
					'icon icon-move'				 => array( 'group' => 'finences-icons' ),
					'icon icon-warning'				 => array( 'group' => 'finences-icons' ),
					'icon icon-question-circle'		 => array( 'group' => 'finences-icons' ),
					'icon icon-menu-circle'			 => array( 'group' => 'finences-icons' ),
					'icon icon-checkmark-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-cross-circle'		 => array( 'group' => 'finences-icons' ),
					'icon icon-plus-circle'			 => array( 'group' => 'finences-icons' ),
					'icon icon-circle-minus'		 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-up-circle'		 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-down-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-left-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-arrow-right-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-up-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-down-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-left-circle'	 => array( 'group' => 'finences-icons' ),
					'icon icon-chevron-right-circle' => array( 'group' => 'finences-icons' ),
					'icon icon-crop'				 => array( 'group' => 'finences-icons' ),
					'icon icon-frame-expand'		 => array( 'group' => 'finences-icons' ),
					'icon icon-frame-contract'		 => array( 'group' => 'finences-icons' ),
					'icon icon-layers2'				 => array( 'group' => 'finences-icons' ),
					'icon icon-funnel'				 => array( 'group' => 'finences-icons' ),
					'icon icon-text-format'			 => array( 'group' => 'finences-icons' ),
					'icon icon-text-size'			 => array( 'group' => 'finences-icons' ),
					'icon icon-bold'				 => array( 'group' => 'finences-icons' ),
					'icon icon-italic'				 => array( 'group' => 'finences-icons' ),
					'icon icon-underline'			 => array( 'group' => 'finences-icons' ),
					'icon icon-strikethrough'		 => array( 'group' => 'finences-icons' ),
					'icon icon-highlight'			 => array( 'group' => 'finences-icons' ),
					'icon icon-text-align-left'		 => array( 'group' => 'finences-icons' ),
					'icon icon-text-align-center'	 => array( 'group' => 'finences-icons' ),
					'icon icon-text-align-right'	 => array( 'group' => 'finences-icons' ),
					'icon icon-text-align-justify'	 => array( 'group' => 'finences-icons' ),
					'icon icon-line-spacing'		 => array( 'group' => 'finences-icons' ),
					'icon icon-indent-increase'		 => array( 'group' => 'finences-icons' ),
					'icon icon-indent-decrease'		 => array( 'group' => 'finences-icons' ),
					'icon icon-page-break'			 => array( 'group' => 'finences-icons' ),
					'icon icon-hand'				 => array( 'group' => 'finences-icons' ),
					'icon icon-pointer-up'			 => array( 'group' => 'finences-icons' ),
					'icon icon-pointer-right'		 => array( 'group' => 'finences-icons' ),
					'icon icon-pointer-down'		 => array( 'group' => 'finences-icons' ),
					'icon icon-pointer-left'		 => array( 'group' => 'finences-icons' ),
				),
			),
		);
	}
